...
var ProviderRegisterPageComponent = (function () {
    function ProviderRegisterPageComponent(providerService) {
        ...
        this.provider = { companyName: '', FirstName: '', LastName: '', UserName: '', Password: '', Category: '',
    ...
    ProviderRegisterPageComponent.prototype.onSubmit = function () {
        this.providerService.createProvider(this.provider).subscribe(function (value) {
            console.log('[POST] create Parent successfully', value);
        }, function () {
            console.log('POST Parent - now completed.');
        });
...
var ProvidersService = (function () {
    ...
    ProvidersService.prototype.createProvider = function (provider) {
        return this.http.post(ProvidersService_1.POST_PARENT_URL, provider, { headers: this.headers });
    };
    ProvidersService.POST_PARENT_URL = '/providers-registration/addNewProvider';
