...
#                  23.7471924, '0957c186102e907c0d70ae9804195cf812a1bf16815f339eab2314b7dc8c9e61', '6938520147', 0),
...
#   ('Anapsyxh', 'Glyfada', 'Diaskedash', 'Antonis', '1122336655889740', 'Remos', 'rem@mail.com',
...
#    'stsirtsis'), ('Mathimata', 'Zografou', 'Didagmata ', 'Panagioths', '4569871230321478', 'Bougoulias', 'bou@mail.com',
#                                '1e58e562b289623a3c1b9d4cebec5307a9eb2e084d2871b0143bedcb442b8ebc', 'Papagou', 50,
#                                '6985456321', 'panosbou'),
#   ('Mousiki', 'Ilioupoli', 'tragoudi', 'Nikos', '7744110022563987', 'Oikonomopoulos', 'oiko@mail.com',
...
#   ('Stand up', 'Ilisia', 'Asteia', 'Kostas', '1220549786315468', 'Salas', 'sal@mail.com',
#                '555ef741f1dcec81fc3d4ae4e358baaff7fb16c753380e3f28d14fcda13259ff', 'Ilision', 45, '6985541230',
#    'salas123'), ('Theatrinos', 'Kolonaki', 'Poulaw psemata', 'Alexis', '9854320167954786', 'Kougias', 'kontos@mail.com',
#                                'da95038333b0fa5f910b157c7d2ea48b17b2a5d0e05d1c22e72a24528544a476', 'Tsakalof', 5,
#                                '6932587417', 'eimaikontos'),
...
#    'braveheart'),
#   ('Ακαδημία', 'Λάρισα', 'Προπόνηση Ποδοσφαίρου', '¶γγελος', '0321454586987451', 'Χαριστέας', 'char@mail.com',
#                '8c74636bbd621a3498dc2bf976da509fbf0b9b61799da71055d24bbba5be04d4', 'Κούμα', 5, '6985858512',
#    'magikokefali');
#
#
# INSERT INTO `event` VALUES
#   (1, 'Zografou', 'Kousidi', 75, 2, 14, 3, 0, '2018-03-22', 'Mathima JAVA', 'Mathima', 20, NULL, 'javalesson.jpg', 15,
#    0, 'Mathimata'),
#   (2, 'Ζωγράφου', 'Παπάγου', 45, 1, 30, 3, 0, '2018-03-17', 'Μάθημα JAVA', 'Μάθημα Java', 30, NULL, 'javalesson.jpg',
#    15, 0, 'Didaskalia'),
#   (3, 'Γλυφάδα', 'Ζαμανού', 5, 2, 50, 2, 0, '2018-03-17', 'Τραγούδι', 'Μάθημα Τραγουδιού', 50, NULL, 'music.jpg', 10, 0,
#    'Anapsyxh'),
#   (4, 'Παγκράτι', 'Φιλολάου', 33, 2, 40, 1, 0, '2018-03-26', 'Μάθημα κιθάρας για αρχάριους', 'Μάθημα Κιθάρας', 40, NULL,
#    'guitarlesson.jpg', 15, 0, 'Didaskalia'),
#   (5, 'Λάρισα', 'Κούμα ', 10, 1, 30, 1, 0, '2018-04-11', 'Προπόνηση ποδοσφαίρου', 'Προπόνηση ποδοσφαίρου', 30, NULL,
#    'footballlesson.jpeg', 5, 0, 'Ακαδημία'),
#   (6, 'Θεσσαλονίκη', 'Τσιμισκή', 55, 2, 100, 3, 0, '2018-04-07', 'Πρώτη επαφή με τον υπολογιστή', 'Υπολογιστές', 100,
#    NULL, 'pclesson.jpg', 5, 0, 'unboxholics'),
#   (7, 'Λάρισα', 'Κούμα', 20, 4, 30, 2, 0, '2018-04-08', 'Θεατρικότητα', 'Μάθημα Θεάτρου', 30, NULL, 'theaterlesson.jpg',
#    10, 0, 'Stand up'),
#   (8, 'Κολωνάκι', 'Τσακάλωφ', 5, 1, 15, 2, 0, '2018-03-14', 'Οι τέχνες', 'Μάθημα Καλών Τεχνών', 15, NULL,
#    'artlesson.jpg', 15, 0, 'Stand up');
#
...
#   (26, '8c6976e5b5410415bde908bd4dee15dfb167a9c873fc4bb8a81f6f2ab448a918', 'admin'),
#   (27, '8c74636bbd621a3498dc2bf976da509fbf0b9b61799da71055d24bbba5be04d4', 'magikokefali');
#
#
# INSERT INTO `role`
...
#   (13, 'Mathimata'), (14, 'PARENT'), (15, 'PARENT'), (16, 'PROVIDER'), (17, 'Theatrinos'), (18, 'PARENT'),
#   (19, 'PARENT'), (20, 'PARENT'), (21, 'PARENT'), (22, 'PARENT'), (23, 'PARENT'), (24, 'PARENT'), (25, 'PARENT'),
#   (26, 'PROVIDER'), (27, 'Run'), (28, 'PROVIDER'), (29, 'Anapsyxh'), (30, 'PROVIDER'), (31, 'Mousiki'),
#   (32, 'PROVIDER'), (33, 'Autokinhsh'), (34, 'PROVIDER'), (35, 'Stand up'), (36, 'ADMIN'), (37, 'PROVIDER'),
#   (38, 'Ακαδημία');
#
