...
* Χρήστες που επηρεάζουν έμμεσα την εφαρμογή: Είναι οι χρήστες οι οποίοι δε φαίνεται απαραίτητα ο ρόλος του στην εφαρμογή, όπως οι χρήστες που εμπίπτουν στις τέσσερις παραπάνω κατηγορίες. Αυτοί είναι οι άνθρωποι που η εφαρμογή τους αποφέρει κέρδη, όπως π.χ. θα μπορούσε να είναι μια εταιρεία, και οι προγραμματιστές που είναι υπεύθυνοι για την ανάπτυξη, συντήρηση και ομαλή λειτουργία της εφαρμογής. Για τη συγκεκριμένη εφαρμογή θεωρούμε ότι οι δυο παραπάνω κατηγορίες ταυτίζονται και έχουν ρόλο διαχειριστή.
