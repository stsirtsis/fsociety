...
•	Διαχειριστής:
διαχειριση χρηστων,αναθεση και ανακληση ρολων και δικαιωματων,κλειδωμα χρηστη(λόγω πολλών αρνητικών σχολίων –παραπόνων ή μη αποδεκτής συμπεριφοράς), reset password χρήστη(πιθανή απώλεια αυτού ή αλλαγη του για λόγους ασφάλειας, εξασφάλιση μοναδικότητας)
